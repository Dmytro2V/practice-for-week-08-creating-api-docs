...
- Edit a post - PATCH /posts:postId
- Create a new user - POST /users
- Get the comments for a post - GET /posts:postId/comments or /comments/post:id
- Create a comment for a post - POST /posts:postId/comments or /comments/post:id
- Edit a comment for a post - PATCH /posts:postId/comments/:commentId
- Delete a comment for a post - DELETE /posts:postId/comments/:commentId
- Add a like for a post - PATCH/PUT /posts:postId/
- Remove a like for a post - PATCH/PUT /posts:postId/
- Get all the posts of a user - GET /users/:userId/posts 
- Submit a search on posts - GET /search
